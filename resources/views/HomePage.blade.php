...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            @if (!auth()->check())
                {{-- this is to make the survey for a guest --}}
            ...
            @auth
                ...
                @if (auth()->user()->role == 0)
                    <li>
                        <a href="/adminPage" class="hover:text-laravel"><i class="fa-solid fa-user-circle"></i> AdminPage</a>
                    </li>
                @endif
                @if ($hairSurvey->isEmpty())
                    {{-- if you are logged in and haven't completed the survey: enter this if statement --}}
